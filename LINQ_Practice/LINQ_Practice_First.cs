...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(pi => pi.PrimaryInstructor.FirstName == "Kate");
        ...
        {
            var ActualCohort = PracticeData.First(j => j.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(c => c.PrimaryInstructor.FirstName == "Zelda" || c.JuniorInstructors.Any(e => e.FirstName == "Zelda"));
