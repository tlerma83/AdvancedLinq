...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(p => p.PrimaryInstructor.FirstName == "Jurnell").ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(j => j.JuniorInstructors.Count == 3).ToList();
