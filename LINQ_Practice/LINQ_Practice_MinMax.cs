...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(c => c.Birthday.Date);
        ...
        {
            var minValue = PracticeData[2].Students.Min(b => b.Birthday.Date);
        ...
        {
            var maxValue = PracticeData.Max(j => j.JuniorInstructors.Count); 
