...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(ji => ji.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(i => i.PrimaryInstructor.FirstName == "Zelda" || i.JuniorInstructors.Any(j => j.FirstName == "Zelda"));
        ...
        {
            var shouldThrowException = PracticeData.Single(i => i.JuniorInstructors.Count > 0);
        }
    }
}
